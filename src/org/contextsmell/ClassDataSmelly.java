...
public class ClassDataSmelly {
	...
	public boolean equals(Object arg0) {
		...
		if (smell != null) {
			return metodo.getDiretorioDaClasse().equals(getDiretorioDaClasse())
					&& metodo.getNomeClasse().equals(getNomeClasse()) && metodo.getCommit().equals(getCommit())
	...
	public int hashCode() {
		if (smell != null)
			return getDiretorioDaClasse().hashCode() + getNomeClasse().hashCode() + getCommit().hashCode()
					+ getSmell().hashCode();
		return getDiretorioDaClasse().hashCode() + getNomeClasse().hashCode() + getCommit().hashCode();
	}
}
